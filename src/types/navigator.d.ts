...
// ! navigator API はまだオフィシャルではないのでtypescriptに入っていません。（https://github.com/Microsoft/TypeScript/issues/27186）
// ! ここからコードをコピペーしています（編集した箇所あり）https://github.com/lacolaco/network-information-types
